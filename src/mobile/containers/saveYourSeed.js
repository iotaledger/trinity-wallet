...
import { checkNode, setSeed } from '../../shared/actions/iotaActions';
import { requestMarketData, requestChartData, requestPrice } from '../../shared/actions/marketDataActions';
        ...
        <View style={styles.midContainer}>
          <View style={styles.leftContainer}>
            <View>
              ...
              <Text style={styles.infoText}>Copy down the seed shown opposite on paper. Triple check this to make sure you have written it down correctly. We have split the seed into groups of 6 characters for easier copying.</Text>
            </View>
            <View>
              <Text style={styles.optionText}>Option B</Text>
              <Text style={styles.infoText}>Click the button opposite to generate a paper wallet. This will create an image that can be printed out and stored safely for future use. Do not store this image in an unencrypted electronic form.</Text>
            </View>
            <View>
              <Text style={styles.optionText}>Option C</Text>
              <Text style={styles.optionCText}>
                <Text style={styles.infoText}>Click the button opposite to copy the seed to the clipboard. You can then paste it into your favourite password manager. This will only stay on your clipboard for </Text>

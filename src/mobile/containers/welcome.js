      ...
      <ImageBackground source={require('../../shared/images/bg-green.png')} style={styles.container}>
        ...
        <View style={styles.midContainer}>
          <View style={styles.infoTextContainer}>
            ...
            <Text style={styles.infoTextLight}>We will spend the next few minutes setting up your wallet.</Text>
            <Text style={styles.infoTextRegular}>You may be tempted to skip some steps, but we urge you to follow the complete process.</Text>
          </View>
        </View>

...
class FingerprintDisable extends Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        this.disableFingerprint = this.disableFingerprint.bind(this);
        this.state = {
            code: '',
    ...
    disableFingerprint() {
        ...
        if (this.state.currentFingerStatus) {
            ...
            this.timeout = setTimeout(() => {
                this.props.generateAlert('success', 'Fingerprint Disabled', 'Fingerprint login has been disabled');
            }, 300);
        } else {
            ...
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                <View style={[styles.container, backgroundColor]}>
                    ...
                    <View style={styles.midWrapper}>
                        ...
                        <Text style={[styles.subHeaderText, textColor]}>Hold finger to verify identity </Text>
                    ...
                    <View style={styles.bottomWrapper}>
                        <OnboardingButtons
                            ...
                            onRightButtonPress={this.disableFingerprint}
...
export default translate(['fingerprintEnable', 'global'])(
    connect(mapStateToProps, mapDispatchToProps)(FingerprintDisable),
);

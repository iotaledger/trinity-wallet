...
import { getChecksum } from 'shared/libs/iota/utils';
import { generateAlert } from 'shared/actions/alerts';
import { paperWalletFilled } from 'shared/images/PaperWallets.js';
import { setSeedShareTutorialVisitationStatus } from 'shared/actions/settings';
    ...
    async print() {
        ...
        <html>
          ...
          <style>
             ...
             @font-face { font-family: "Monospace"; src: "custom-fonts/SourceCodePro-Medium.ttf"
          </style>
          <body>
            ${this.getHTMLContent()}
            ${paperWalletFilled}

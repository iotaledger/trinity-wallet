...
import { StyleSheet, View, Text, TouchableWithoutFeedback, TouchableOpacity, RefreshControl } from 'react-native';
...
class History extends Component {
    static propTypes = {
        ...
        /** @ignore */
        moonPayPurchases: PropTypes.array,
        /** @ignore */
    ...
    prepMoonPayPurchases() {
        ...
        const formattedTransfers = map(moonPayPurchases, (purchase) => {
            ...
            const amount = quoteCurrencyAmount * 1000000;
    ...
    renderMoonpayPurchases() {
        ...
        const data = this.prepMoonPayPurchases();
            ...
            <OptimizedFlatList
                ...
                ListEmptyComponent={
                    <View style={styles.noTransactionsContainer}>
                        <InfoBox>
                            <Text style={[styles.infoText, { color: body.color }]}>{t('moonpay:emptyHistory')}</Text>
                            <CtaButton
    ...
    render() {
        const { t, theme: { dark, body }, setViewingMoonpayPurchases, isViewingMoonpayPurchases } = this.props;
                ...
                <View style={styles.container}>
                    <View style={styles.headerButtonsContainer}>
                        <TouchableOpacity onPress={() => setViewingMoonpayPurchases(false)}>
                            <View style={[styles.leftHeaderButton, { backgroundColor: isViewingMoonpayPurchases ? dark.color : body.bg }]}>
                                <Text style={[styles.buttonText, { color: body.color }]}>
                                    {t('transactions')}
                                </Text>
                            </View>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setViewingMoonpayPurchases(true)}>
                            <View style={[styles.rightHeaderButton, { backgroundColor: isViewingMoonpayPurchases ? body.bg : dark.color }]}>
                    ...
                    <View style={styles.listContainer}>
                        <View style={styles.list}>{isViewingMoonpayPurchases ? this.renderMoonpayPurchases() : this.renderIOTATransactions()}</View>
                    </View>
                </View>

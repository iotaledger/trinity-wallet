  ...
  <head>
    ...
    <style>
      ...
      .button-right {
        ...
        flex: 1;
        color: rgb(0, 50, 65);
        background-color: rgb(65, 220, 243);
        font-family: 'Source Sans Pro', sans-serif;
        font-weight: 600;
        font-size: 18px;
      }
  ...
  <main>
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <svg style="fill:#fff;" width="350px" height="150px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="header-container">
            ...
            <span class="subtitle">Please enter your billing details below</span>
            </div>
            <form id="cc-form" class="form-container form-custom">
              <div class="form-group">
                <label for="cc-number" class="field-label">Card number</label>
                <span id="cc-number" class="form-field">
                  <!--VGS Collect iframe for card number field will be here!-->
                </span>
              </div>
              <div class="form-group">
                <label for="cc-cvc" class="field-label">CVC</label>
                <span id="cc-cvc" class="form-field">
                <!--VGS Collect iframe for CVC field will be here!-->
                </span>
              </div>
              <div class="form-group">
                <label for="cc-expiration-date" class="field-label">Expiration date</label>
              ...
              <button type="button" onclick="goBack()" class="button-left">Back</button>
    ...
    render() {
        return (
            <WebView
                ...
                source={{ html: VGSCollectFormHTMl }}
                javaScriptEnabled

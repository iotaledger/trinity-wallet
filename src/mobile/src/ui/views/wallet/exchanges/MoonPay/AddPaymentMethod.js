  ...
  <main>
    <div class="row">
      ...
      <div class="col-md-4 mb-4">
        ...
        <svg style="fill:${theme.body.color}" width="350px" height="150px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="header-container">
            ...
            <form id="cc-form" class="form-container form-custom">
              ...
              <input type="button" value="Back" onclick="goBack()" class="button-left" />

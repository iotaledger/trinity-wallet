...
@objc class Argon2IOS: NSObject {
  ...
  @objc func hash(params: [String: Any], password: String, resolver resolve: RCTPromiseResolveBlock, rejecter reject: RCTPromiseRejectBlock) -> Void {
    // Validate parameters
  ...
  ///   - resolve: A JS Promise resolve block
  ///   - reject: A JS Promise reject block
  @objc func verify(params: [String: Any], hash: String, password: String, resolver resolve: RCTPromiseResolveBlock, rejecter reject: RCTPromiseRejectBlock) -> Void {
    if params["iterations"] is Int && params["salt"] is String && params["hashLength"] is Int && params["parallelism"] is Int {

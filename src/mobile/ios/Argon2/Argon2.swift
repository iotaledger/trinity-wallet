...
func initialize(iterations: Int, salt: String, hashLength: Int, parallelism: Int) -> CatArgon2Crypto {
...
func hash(params: [String: Any], password: String) -> String {
  // Initialize Argon2
...
///   - password: Hash to verify
/// - Returns: Result of verification
func verify(params: [String: Any], hash: String, password: String) -> Bool {
  // Initialize Argon2
  let argon2Crypto = initialize(iterations: params["iterations"] as! Int, salt: params["salt"] as! String, hashLength: params["hashLength"] as! Int, parallelism: params["parallelism"] as! Int)

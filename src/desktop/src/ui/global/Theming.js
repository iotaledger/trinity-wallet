...
class Colors extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={css.theming}>
                <div>
                    <Select
                        label="Theme"
                        value={themeNames.indexOf(this.props.themeName) > -1 ? this.props.themeName : ''}
                        onChange={(e) => this.props.updateTheme(themes[e.target.value], e.target.value)}
                    >
                            ...
                            {Object.keys(theme[set]).map((color) => {
                                return (
                                    <div key={`${set}.${color}`}>
                                        ...
                                        <span>{colorTitles[`${set}.${color}`]} </span>
                                        <strong>
                                            <input

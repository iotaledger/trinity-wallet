...
bar: { bg: 'rgb(20, 23, 37)',hover: 'rgb(33, 38, 62)',alt: 'rgb(26, 36, 50)',color: 'rgb(240, 242, 246)', },
label: { color: 'rgb(240, 242, 246)',hover: 'rgb(65, 220, 243)', },
input: { bg: 'rgb(15, 62, 88)',border: 'rgba(255, 255, 255, 0.1)',alt: 'rgb(148, 168, 172)',hover: 'rgba(255, 255, 255, 0.4)',color: 'rgb(255, 255, 255)', },
...
wave: { primary: 'rgba(49, 94, 119, 0.12)',secondary: 'rgba(11, 27, 31, 0.6)', },
};

...
Wir verwenden Bugsnag der Bugsnag Inc., 939 Harrison St, San Francisco, Kalifornien 94107, USA („Bugsnag”), um Protokolle von Abstürzen und Fehlern zu beziehen, die sich ereignen, während ein Nutzer die App verwendet. Tritt ein Fehler auf, so werden der Unique Identifier in anonymisierter Form sowie Informationen über Ihre Einstellungen an Bugsnag übermittelt. Weitere Informationen finden Sie unter [http://docs.bugsnag.com/legal/privacy-policy](http://docs.bugsnag.com/legal/privacy-policy).

#### **CryptoCompare**

Wir nutzen CryptoCompare API der Crypto Coin Comparison Limited, 162 Main Road, Danbury, Chelmsford, England CM3 4DT ("CryptoCompare") um statistische Preis- und Marktdaten für Krypto-Währungen zu erhalten. Weitere Informationen finden Sie unter [https://www.cryptocompare.com/privacy-policy/](https://protect-eu.mimecast.com/s/jjoIC868JFzJklpSnZWeH?domain=cryptocompare.com).

#### **GitHub**

Wir nutzen GitHub der GitHub Inc 88 Colin P. Kelly Street, San Francisco, CA 94107, USA (“GitHub” – innerhalb der Europäischen Union: GitHub BV Vijzelstraat 68-72, 1017 HL Amsterdam, The Netherlands) um nach App-Updates zu suchen, um die Auto-Update-Funktionalität zur Verfügung zu stellen. Weitere Informationen finden Sie unter [https://help.github.com/articles/github-privacy-statement/](https://protect-eu.mimecast.com/s/pbXoCmQR3FA0MZNH3GMUB?domain=help.github.com).

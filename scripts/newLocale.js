...
const sharedi18nResourcesArr = fs
    .readFileSync('../src/shared/i18next.js')
    .toString()
    .split('\n');
const mobilei18nResourcesArr = fs
    .readFileSync('../src/mobile/i18next.js')
    .toString()
    .split('\n');
const desktopi18nResourcesArr = fs
    .readFileSync('../src/desktop/src/libs/i18next.js')
    .toString()
    .split('\n');
